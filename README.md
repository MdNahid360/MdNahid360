...
<svg xmlns="http://www.w3.org/2000/svg" width="480" height="350" class="">
    ...
    <foreignObject x="0" y="0" width="100%" height="100%">
        <div xmlns="http://www.w3.org/1999/xhtml" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <div class="field calendar">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 210 11" width="210" height="16">
                                <g>
                                    ...
                                    <rect class="day" x="60" y="0" width="11" height="11" fill="var(--color-calendar-graph-day-L1-bg)" rx="2" ry="2"/>
                                    <rect class="day" x="75" y="0" width="11" height="11" fill="var(--color-calendar-graph-day-L1-bg)" rx="2" ry="2"/>
                                    <rect class="day" x="90" y="0" width="11" height="11" fill="var(--color-calendar-graph-day-bg)" rx="2" ry="2"/>
                                    <rect class="day" x="105" y="0" width="11" height="11" fill="var(--color-calendar-graph-day-L1-bg)" rx="2" ry="2"/>
                                    <rect class="day" x="120" y="0" width="11" height="11" fill="var(--color-calendar-graph-day-bg)" rx="2" ry="2"/>
                                    <rect class="day" x="135" y="0" width="11" height="11" fill="var(--color-calendar-graph-day-L4-bg)" rx="2" ry="2"/>
                                    <rect class="day" x="150" y="0" width="11" height="11" fill="var(--color-calendar-graph-day-L1-bg)" rx="2" ry="2"/>
                ...
                <div class="row fill-width">
                    <section class="column">
                        ...
                        <svg class="bar" xmlns="http://www.w3.org/2000/svg" width="220" height="8">
                            ...
                            <rect mask="url(#issues-bar)" x="0" y="0" width="6.75438596491228" height="8" fill="#238636"/>
                            <rect mask="url(#issues-bar)" x="6.75438596491228" y="0" width="0" height="8" fill="#56d364"/>
                            <rect mask="url(#issues-bar)" x="6.75438596491228" y="0" width="0" height="8" fill="#8B949E"/>
                            <rect mask="url(#issues-bar)" x="6.75438596491228" y="0" width="0" height="8" fill="#c9d1d9"/>
                            <rect mask="url(#issues-bar)" x="6.75438596491228" y="0" width="213.24561403508773" height="8" fill="#8957e5"/>
                        ...
                        <div class="followup legend field fill-width">
                            ...
                            <div class="field">
                                ...
                                <span class="no-wrap">221 <small>closed</small></span>
                            </div>
                            <div class="field">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
                    ...
                    <section class="column">
                        ...
                        <svg class="bar" xmlns="http://www.w3.org/2000/svg" width="220" height="8">
                            ...
                            <rect mask="url(#issues-bar)" x="0" y="0" width="0.8961303462321791" height="8" fill="#238636"/>
                            <rect mask="url(#issues-bar)" x="0.8961303462321791" y="0" width="0" height="8" fill="#56d364"/>
                            <rect mask="url(#issues-bar)" x="0.8961303462321791" y="0" width="0" height="8" fill="#8B949E"/>
                            <rect mask="url(#issues-bar)" x="0.8961303462321791" y="0" width="0" height="8" fill="#c9d1d9"/>
                            <rect mask="url(#issues-bar)" x="0.8961303462321791" y="0" width="20.61099796334012" height="8" fill="#da3633"/>
                            <rect mask="url(#issues-bar)" x="21.507128309572302" y="0" width="0" height="8" fill="#ff7b72"/>
                            <rect mask="url(#issues-bar)" x="21.507128309572302" y="0" width="198.4928716904277" height="8" fill="#8957e5"/>
                            <rect mask="url(#issues-bar)" x="220" y="0" width="0" height="8" fill="#d2a8ff"/>
                        </svg>
                        <div class="followup legend field fill-width">
                            <div class="field">
                            ...
                            <div class="field">
                                ...
                                <span class="no-wrap">46 <small>closed</small></span>
                            </div>
                        </div>
                    </section>
                </div>
            ...
            <footer>
                <span>Last updated 19 Mar 2022, 08:56:39 with lowlighter/metrics@3.22.0-beta</span>
            </footer>
        </div>
